...
public interface AlipayService {
     ...
     **/
    Map create_pay(String auth_code,String out_trade_no,String total_amount);
     ...
     * @return java.util.Map
     **/
    Map pay_refund(String out_trade_no, String refund_amount);
     ...
     * @return java.util.Map
     **/
    Map pay_cancel(String out_trade_no);
